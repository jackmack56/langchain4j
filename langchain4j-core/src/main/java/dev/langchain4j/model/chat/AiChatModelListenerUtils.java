...
@Internal
public class AiChatModelListenerUtils {
    private static final Logger LOG = LoggerFactory.getLogger(AiChatModelListenerUtils.class);

    private AiChatModelListenerUtils() {
    }
