...
import dev.langchain4j.model.openai.spi.AiStreamingChatModelBuilderFactory;
...
public class AiStreamingChatModel implements AiStreamChatModel {
    ...
    @Override
    public void doChat(ChatRequest chatRequest, AiStreamingChatResponseHandler handler) {
        ...
        client.chatCompletion(openAiRequest)
                .onPartialResponse(partialResponse -> {
                    if (Utils.isNullOrEmpty(partialResponse.model())) {
                        partialResponse.model(openAiRequest.model());
                    }
                    if (Utils.isNullOrEmpty(partialResponse.object())) {
                        partialResponse.object("chat.completion.chunk");
                    }
    ...
    private static void handle(ChatCompletionResponse partialResponse,
                               AiStreamingChatResponseHandler handler) {
    ...
    public static AiStreamingChatModelBuilder builder() {
        for (AiStreamingChatModelBuilderFactory factory : loadFactories(AiStreamingChatModelBuilderFactory.class)) {
            return factory.get();
        }
        return new AiStreamingChatModelBuilder();
    }

    public static class AiStreamingChatModelBuilder {
        ...
        public AiStreamingChatModelBuilder httpClientBuilder(HttpClientBuilder httpClientBuilder) {
         ...
         */
        public AiStreamingChatModelBuilder defaultRequestParameters(ChatRequestParameters parameters) {
            this.defaultRequestParameters = parameters;
            return this;
        }

        public AiStreamingChatModelBuilder modelName(String modelName) {
            this.modelName = modelName;
            return this;
        }

        public AiStreamingChatModelBuilder modelName(OpenAiChatModelName modelName) {
            this.modelName = modelName.toString();
            return this;
        }

        public AiStreamingChatModelBuilder baseUrl(String baseUrl) {
            this.baseUrl = baseUrl;
            return this;
        }

        public AiStreamingChatModelBuilder apiKey(String apiKey) {
            this.apiKey = apiKey;
            return this;
        }

        public AiStreamingChatModelBuilder organizationId(String organizationId) {
            this.organizationId = organizationId;
            return this;
        }

        public AiStreamingChatModelBuilder projectId(String projectId) {
            this.projectId = projectId;
            return this;
        }

        public AiStreamingChatModelBuilder temperature(Double temperature) {
            this.temperature = temperature;
            return this;
        }

        public AiStreamingChatModelBuilder topP(Double topP) {
            this.topP = topP;
            return this;
        }

        public AiStreamingChatModelBuilder stop(List<String> stop) {
            this.stop = stop;
            return this;
        }

        public AiStreamingChatModelBuilder maxTokens(Integer maxTokens) {
            this.maxTokens = maxTokens;
            return this;
        }

        public AiStreamingChatModelBuilder maxCompletionTokens(Integer maxCompletionTokens) {
            this.maxCompletionTokens = maxCompletionTokens;
            return this;
        }

        public AiStreamingChatModelBuilder presencePenalty(Double presencePenalty) {
            this.presencePenalty = presencePenalty;
            return this;
        }

        public AiStreamingChatModelBuilder frequencyPenalty(Double frequencyPenalty) {
            this.frequencyPenalty = frequencyPenalty;
            return this;
        }

        public AiStreamingChatModelBuilder logitBias(Map<String, Integer> logitBias) {
            this.logitBias = logitBias;
            return this;
        }

        public AiStreamingChatModelBuilder responseFormat(String responseFormat) {
            this.responseFormat = responseFormat;
            return this;
        }

        public AiStreamingChatModelBuilder strictJsonSchema(Boolean strictJsonSchema) {
            this.strictJsonSchema = strictJsonSchema;
            return this;
        }

        public AiStreamingChatModelBuilder seed(Integer seed) {
            this.seed = seed;
            return this;
        }

        public AiStreamingChatModelBuilder user(String user) {
            this.user = user;
            return this;
        }

        public AiStreamingChatModelBuilder strictTools(Boolean strictTools) {
            this.strictTools = strictTools;
            return this;
        }

        public AiStreamingChatModelBuilder parallelToolCalls(Boolean parallelToolCalls) {
            this.parallelToolCalls = parallelToolCalls;
            return this;
        }

        public AiStreamingChatModelBuilder store(Boolean store) {
            this.store = store;
            return this;
        }

        public AiStreamingChatModelBuilder metadata(Map<String, String> metadata) {
            this.metadata = metadata;
            return this;
        }

        public AiStreamingChatModelBuilder serviceTier(String serviceTier) {
            this.serviceTier = serviceTier;
            return this;
        }

        public AiStreamingChatModelBuilder timeout(Duration timeout) {
            this.timeout = timeout;
            return this;
        }

        public AiStreamingChatModelBuilder logRequests(Boolean logRequests) {
            this.logRequests = logRequests;
            return this;
        }

        public AiStreamingChatModelBuilder logResponses(Boolean logResponses) {
